...
const CourseCard = ({ data }: any) => {
    return (
        <Link href={`/product/${data.id}`} className="border bg-white block rounded-lg w-fit overflow-hidden hover:border-primary/30 transition-colors duration-150">
            ...
            <div className="p-4">
                ...
                <p className="text-sm text-teal-600 font-medium truncate">Instructor Name</p>
