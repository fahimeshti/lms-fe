    ...
    return (
        <div className="custom-container">
            <CoursesSliderContainer
                ...
                navigations={
                    <>
                        <button className="arrow-left-hero slider-arrow-custom absolute top-1/2 -left-3 sm:-left-4 -translate-y-1/2 rounded-full text-primary hover:text-teal-600 p-1 disabled:bg-gray-200 transition-all duration-150">
                            <ChevronLeft size={32} strokeWidth={1.5} />
                        </button>
                        <button className="arrow-right-hero slider-arrow-custom absolute top-1/2 -right-3 sm:-right-4 -translate-y-1/2 rounded-full text-primary hover:text-teal-600 p-1 disabled:bg-gray-200 transition-all duration-150">
