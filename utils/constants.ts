...
export const AUTH_TOKEN_KEY = "_access_token";
export const USER_PROFILE_KEY = "_user_profile";
export const IMAGE_FALLBACK =
  "https://placehold.co/600x400?text=Image+Not\nAvailable";
export const BUY_NOW_KEY = "buy_now";
