...
const SignIn: React.FC = () => {
  ...
  useEffect(() => {
    if (data) {
      localStorage.setItem(AUTH_TOKEN, data.data?.data?.session?.access_token);
      localStorage.setItem("lms_user_profile", JSON.stringify(data.data?.data?.user));
      login();
              ...
              <form onSubmit={form.handleSubmit(onSubmit)}>
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <Input form={form} name='email' placeholder="Enter your email" />
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <Input form={form} type="password" name='password' placeholder="Enter your password" />
                    <span className="absolute right-4 top-4">
                      <svg
                        className="fill-current"
                        width="22"
                ...
                <div className="mb-5">
                  <input
                    ...
                    disabled={loading}
                    value="Sign In"
                    className="w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90 disabled:bg-gray-400 disabled:cursor-not-allowed disabled:border-gray-400 dark:border-primarydark dark:bg-primarydark dark:hover:bg-opacity-90 dark:disabled:bg-gray-400 dark:disabled:border-gray-400"
                  />
                </div>
